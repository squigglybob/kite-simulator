...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    sliders: [
      ...
      { path: 'kite.trimDeg', label: 'bridle trim deg', min: 0, max: 35, step: 0.5 },
      { path: 'kite.pitchStiffness', label: 'pitch stiffness', min: 0.2, max: 30, step: 0.1 },
      { path: 'kite.pitchDamp', label: 'pitch damping', min: 0, max: 6, step: 0.05 },
      { path: 'kite.pitchInertia', label: 'pitch inertia', min: 0.005, max: 0.4, step: 0.005 },
      ...
      { path: 'kite.tailStrength', label: 'tail strength', min: 0, max: 12, step: 0.1 },
      { path: 'kite.rollDamp', label: 'roll damping', min: 0, max: 4, step: 0.02 },
